...
!if [call create-lists.bat header libffi-vs$(VSVER)-$(PLAT).mak libffi_OBJS]
!endif

!if [for %c in (..\src\*.c) do @call create-lists.bat file libffi-vs$(VSVER)-$(PLAT).mak vs^$(VSVER)\^$(CFG)\^$(PLAT)\libffi\%~nc.obj]
!endif

!if [for %c in ($(ARCH_SRCDIR)\*.c) do @call create-lists.bat file libffi-vs$(VSVER)-$(PLAT).mak vs^$(VSVER)\^$(CFG)\^$(PLAT)\libffi\%~nc.obj]
!endif

!if [call create-lists.bat file libffi-vs$(VSVER)-$(PLAT).mak vs^$(VSVER)\^$(CFG)\^$(PLAT)\libffi\plat_asm.obj]
!endif

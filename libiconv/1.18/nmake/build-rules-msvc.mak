...
{..\srclib\}.c{vs$(VSVER)\$(CFG)\$(PLAT)\iconv-gnulib\}.obj::
	...
	$(CC) $(ICONV_INCLUDES) $(ICONV_CFLAGS) /DLIBPATHVAR=\"PATH\" /DLIBDIRS=\"c:/software.b/libiconv-1.18/bin\" /DINSTALLDIR=\"c:/software.b/libiconv-1.18/bin\" /Fovs$(VSVER)\$(CFG)\$(PLAT)\iconv-gnulib\ /Fdvs$(VSVER)\$(CFG)\$(PLAT)\iconv-gnulib\ /c @<<
$<
<<

...
{..\srclib\}.c{vs$(VSVER)\$(CFG)\$(PLAT)\iconv-gnulib\}.obj::
	...
	$(CC) $(ICONV_INCLUDES) $(ICONV_CFLAGS) /DLIBPATHVAR=\"PATH\" /DLIBDIRS=\"c:/software.b/libiconv-$(LIBICONV_VERSION_MAJOR).$(LIBICONV_VERSION_MINOR)/bin\" /DINSTALLDIR=\"c:/software.b/libiconv-$(LIBICONV_VERSION_MAJOR).$(LIBICONV_VERSION_MINOR)/bin\" /Fovs$(VSVER)\$(CFG)\$(PLAT)\iconv-gnulib\ /Fdvs$(VSVER)\$(CFG)\$(PLAT)\iconv-gnulib\ /c @<<
$<
<<

{..\srclib\glthread\}.c{vs$(VSVER)\$(CFG)\$(PLAT)\iconv-gnulib\}.obj::
	@if not exist vs$(VSVER)\$(CFG)\$(PLAT)\iconv-gnulib md vs$(VSVER)\$(CFG)\$(PLAT)\iconv-gnulib

...
!ifndef GETTEXT_INCLUDEDIR
GETTEXT_INCLUDEDIR = $(PREFIX)\include
!endif
...
ICONV_BASE_PATH_DEFINES =	\
	/DINSTALLDIR=\"c:/vs14.0/$(PLAT)\" 	\
	/DLOCALEDIR=\"c:/vs14.0/$(PLAT)/share/locale\"
...
ICONV_INCLUDES = $(ICONV_INCLUDES) /I$(GETTEXT_INCLUDEDIR)

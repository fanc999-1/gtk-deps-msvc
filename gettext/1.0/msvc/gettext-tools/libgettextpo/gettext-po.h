...
#  define LIBGETTEXTPO_API extern __declspec (dllexport)
# else
#  define LIBGETTEXTPO_API extern __declspec (dllimport)
# endif
#else
# define LIBGETTEXTPO_API extern
#endif
...
LIBGETTEXTPO_API int libgettextpo_version;
...
LIBGETTEXTPO_API po_file_t po_file_write (po_file_t file, const char *filename,
                                          po_xerror_handler_t handler);

/* Free a PO file from memory.  */
LIBGETTEXTPO_API void po_file_free (po_file_t file);

/* Return the names of the domains covered by a PO file in memory.  */
LIBGETTEXTPO_API const char * const * po_file_domains (po_file_t file);
...
LIBGETTEXTPO_API const char * po_file_domain_header (po_file_t file, const char *domain);

/* Return the value of a field in a header entry.
   The return value is either a freshly allocated string, to be freed by the
   caller, or NULL.  */
LIBGETTEXTPO_API char * po_header_field (const char *header, const char *field);
...
LIBGETTEXTPO_API char * po_header_set_field (const char *header, const char *field, const char *value);
...
/* Create an iterator for traversing a domain of a PO file in memory.
   The domain NULL denotes the default domain.  */
LIBGETTEXTPO_API po_message_iterator_t po_message_iterator (po_file_t file, const char *domain);

/* Free an iterator.  */
LIBGETTEXTPO_API void po_message_iterator_free (po_message_iterator_t iterator);

/* Return the next message, and advance the iterator.
   Return NULL at the end of the message list.  */
LIBGETTEXTPO_API po_message_t po_next_message (po_message_iterator_t iterator);
...
/* Insert a message in a PO file in memory, in the domain and at the position
   ...
   inserted message.  */
LIBGETTEXTPO_API void po_message_insert (po_message_iterator_t iterator, po_message_t message);
...
LIBGETTEXTPO_API po_message_t po_message_create (void);


/* Return the context of a message, or NULL for a message not restricted to a
   context.  */
LIBGETTEXTPO_API const char * po_message_msgctxt (po_message_t message);

/* Change the context of a message. NULL means a message not restricted to a
   context.  */
LIBGETTEXTPO_API void po_message_set_msgctxt (po_message_t message, const char *msgctxt);


/* Return the msgid (untranslated English string) of a message.  */
LIBGETTEXTPO_API const char * po_message_msgid (po_message_t message);

/* Change the msgid (untranslated English string) of a message.  */
LIBGETTEXTPO_API void po_message_set_msgid (po_message_t message, const char *msgid);

/* Return the msgid_plural (untranslated English plural string) of a message,
   or NULL for a message without plural.  */
LIBGETTEXTPO_API const char * po_message_msgid_plural (po_message_t message);

/* Change the msgid_plural (untranslated English plural string) of a message.
   NULL means a message without plural.  */
LIBGETTEXTPO_API void po_message_set_msgid_plural (po_message_t message, const char *msgid_plural);


/* Return the msgstr (translation) of a message.
   Return the empty string for an untranslated message.  */
LIBGETTEXTPO_API const char * po_message_msgstr (po_message_t message);

/* Change the msgstr (translation) of a message.
   Use an empty string to denote an untranslated message.  */
LIBGETTEXTPO_API void po_message_set_msgstr (po_message_t message, const char *msgstr);
...
LIBGETTEXTPO_API const char * po_message_msgstr_plural (po_message_t message, int index);
...
LIBGETTEXTPO_API void po_message_set_msgstr_plural (po_message_t message, int index, const char *msgstr);


/* Return the comments for a message.  */
LIBGETTEXTPO_API const char * po_message_comments (po_message_t message);

/* Change the comments for a message.
   comments should be a multiline string, ending in a newline, or empty.  */
LIBGETTEXTPO_API void po_message_set_comments (po_message_t message, const char *comments);


/* Return the extracted comments for a message.  */
LIBGETTEXTPO_API const char * po_message_extracted_comments (po_message_t message);

/* Change the extracted comments for a message.
   comments should be a multiline string, ending in a newline, or empty.  */
LIBGETTEXTPO_API void po_message_set_extracted_comments (po_message_t message, const char *comments);


/* Return the i-th file position for a message, or NULL if i is out of
   range.  */
LIBGETTEXTPO_API po_filepos_t po_message_filepos (po_message_t message, int i);

/* Remove the i-th file position from a message.
   The indices of all following file positions for the message are decremented
   by one.  */
LIBGETTEXTPO_API void po_message_remove_filepos (po_message_t message, int i);
...
LIBGETTEXTPO_API void po_message_add_filepos (po_message_t message, const char *file, size_t start_line);


/* Return the previous context of a message, or NULL for none.  */
LIBGETTEXTPO_API const char * po_message_prev_msgctxt (po_message_t message);

/* Change the previous context of a message.  NULL is allowed.  */
LIBGETTEXTPO_API void po_message_set_prev_msgctxt (po_message_t message, const char *prev_msgctxt);

/* Return the previous msgid (untranslated English string) of a message, or
   NULL for none.  */
LIBGETTEXTPO_API const char * po_message_prev_msgid (po_message_t message);

/* Change the previous msgid (untranslated English string) of a message.
   NULL is allowed.  */
LIBGETTEXTPO_API void po_message_set_prev_msgid (po_message_t message, const char *prev_msgid);

/* Return the previous msgid_plural (untranslated English plural string) of a
   message, or NULL for none.  */
LIBGETTEXTPO_API const char * po_message_prev_msgid_plural (po_message_t message);

/* Change the previous msgid_plural (untranslated English plural string) of a
   message.  NULL is allowed.  */
LIBGETTEXTPO_API void po_message_set_prev_msgid_plural (po_message_t message, const char *prev_msgid_plural);


/* Return true if the message is marked obsolete.  */
LIBGETTEXTPO_API int po_message_is_obsolete (po_message_t message);

/* Change the obsolete mark of a message.  */
LIBGETTEXTPO_API void po_message_set_obsolete (po_message_t message, int obsolete);


/* Return true if the message is marked fuzzy.  */
LIBGETTEXTPO_API int po_message_is_fuzzy (po_message_t message);

/* Change the fuzzy mark of a message.  */
LIBGETTEXTPO_API void po_message_set_fuzzy (po_message_t message, int fuzzy);

/* Return true if the message has a given workflow flag.
   This function is a generalization of po_message_is_fuzzy.  */
LIBGETTEXTPO_API int po_message_has_workflow_flag (po_message_t message, const char *workflow_flag);

/* Set or unset a given workflow flag on a message.
   This function is a generalization of po_message_set_fuzzy.    */
LIBGETTEXTPO_API void po_message_set_workflow_flag (po_message_t message, const char *workflow_flag, int value);

/* Create an iterator for traversing the list of workflow flags of a message.
   This includes the "fuzzy" flag.  */
LIBGETTEXTPO_API po_flag_iterator_t po_message_workflow_flags_iterator (po_message_t message);


/* Return true if the message is marked as being a format string of the given
   type (e.g. "c-format").  */
LIBGETTEXTPO_API int po_message_is_format (po_message_t message, const char *format_type);
...
LIBGETTEXTPO_API int po_message_get_format (po_message_t message, const char *format_type);
...
LIBGETTEXTPO_API void po_message_set_format (po_message_t message, const char *format_type, int value);
...
LIBGETTEXTPO_API int po_message_has_sticky_flag (po_message_t message, const char *sticky_flag);

/* Set or unset a given sticky flag on a message.
   This function is a generalization of po_message_set_format.  */
LIBGETTEXTPO_API void po_message_set_sticky_flag (po_message_t message, const char *sticky_flag, int value);
...
LIBGETTEXTPO_API po_flag_iterator_t po_message_sticky_flags_iterator (po_message_t message);


/* If a numeric range of a message is set, return true and store the minimum
   and maximum value in *MINP and *MAXP.  */
LIBGETTEXTPO_API int po_message_is_range (po_message_t message, int *minp, int *maxp);
...
/* Change the numeric range of a message.  MIN and MAX must be non-negative,
   ...
   message.  */
LIBGETTEXTPO_API void po_message_set_range (po_message_t message, int min, int max);


/* =========================== po_filepos_t API ============================ */

/* Return the file name.  */
LIBGETTEXTPO_API const char * po_filepos_file (po_filepos_t filepos);

/* Return the line number where the string starts, or (size_t)(-1) if no line
   number is available.  */
LIBGETTEXTPO_API size_t po_filepos_start_line (po_filepos_t filepos);


/* ============================ Format type API ============================= */

/* Return a NULL terminated array of the supported format types.  */
LIBGETTEXTPO_API const char * const * po_format_list (void);
...
LIBGETTEXTPO_API const char * po_format_pretty_name (const char *format_type);


/* ========================= po_flag_iterator_t API ========================= */

/* Free an iterator.  */
LIBGETTEXTPO_API void po_flag_iterator_free (po_flag_iterator_t iterator);

/* Return the next flag, and advance the iterator.
   Return NULL at the end of the list of flags.  */
LIBGETTEXTPO_API const char * po_flag_next (po_flag_iterator_t iterator);
...
LIBGETTEXTPO_API void po_file_check_all (po_file_t file, po_xerror_handler_t handler);
...
LIBGETTEXTPO_API void po_message_check_all (po_message_t message, po_message_iterator_t iterator, po_xerror_handler_t handler);
...
LIBGETTEXTPO_API void po_message_check_format (po_message_t message, po_xerror_handler_t handler);

...
#define PKGDATADIR PREFIX "\\share\\gettext"
#define PKGINCLUDEDIR PREFIX "\\include\\gettext"
#define PKGLIBDIR PREFIX "\\lib\\gettext"
#define PKGLIBEXECDIR PREFIX "\\libexec\\gettext"

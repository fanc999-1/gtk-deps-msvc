...
#elif (defined _WIN32 && !defined __CYGWIN__) && !defined (INTL_STATIC)
...
#  ifdef _INTL_REDIRECT_INLINE
extern LIBINTL_DLL_EXPORTED
 wchar_t *libintl_wbindtextdomain (const char *__domainname,
...
#   endif
extern LIBINTL_DLL_EXPORTED
 wchar_t *wbindtextdomain (const char *__domainname,
                                 const wchar_t *__wdirname)

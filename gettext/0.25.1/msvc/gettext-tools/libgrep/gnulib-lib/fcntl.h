...
#if defined __need_system_fcntl_h || defined _GL_GRGL_ALREADY_INCLUDING_FCNTL_H
...
#ifndef _GL_GRGL_FCNTL_H

#define _GL_GRGL_ALREADY_INCLUDING_FCNTL_H
...
#undef _GL_GRGL_ALREADY_INCLUDING_FCNTL_H

#ifndef _GL_GRGL_FCNTL_H
#define _GL_GRGL_FCNTL_H

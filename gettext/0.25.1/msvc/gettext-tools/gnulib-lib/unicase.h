...
extern DLL_VARIABLE const casing_prefix_context_t unicase_empty_prefix_context;
...
extern DLL_VARIABLE const casing_suffix_context_t unicase_empty_suffix_context;
